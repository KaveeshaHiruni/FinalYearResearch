...
cap_road2 = cv2.VideoCapture("../Videos/lowresFullRoad.mp4")  # No bare road and available instance within first 30s
...
while True:
        ...
        if id in vehicleCrossingTimes and (cy > limits1[1] or cx > limits1[2]):
            ...
            if speed > 7.0:
                ...
                if 0 < elapsed_time <= 100:
                    ...
                    distance_to_intersection = 20  # Set a static distance of 20 for speeding vehicles
                    ...
                    green_timer_one = time_to_intersection_one  # Set the green timer to this time

                    # Format the time_to_intersection for display (e.g., in seconds)
                    time_to_intersection_text = f"Time to Intersection: {green_timer_one:.2f} seconds"
    ...
    for result in resultsTracker_road2:
        ...
        if id in vehicleCrossingTimes1 and (cy > limits1[1] or cx > limits1[2]):
            ...
            # Check if the speed exceeds 100 m/s and capture a screenshot
            if speed > 7.0:
