...
cap_road = cv2.VideoCapture("../Videos/lowresfullroad_ff.mp4")  # No bare road and available instance within first 30s
cap_road2 = cv2.VideoCapture("../Videos/resLow.mp4")  # No bare road and available instance within first 30s
...
def update_timer_and_state():
    global green_timer_one, traffic_light_state, img_road
