...
cap = cv2.VideoCapture("../Videos/edited.mp4")  # for videos
    ...
    for r in customResults:
        ...
        for box in boxes:
            ...
            if conf > 0.9:
                ...
                cvzone.putTextRect(img, f'{customClassNames[cls]} {conf}', (max(0, x1), max(35, y1)), scale=2,
                                   thickness=2)
