...
# Second Logic
# cap_road = cv2.VideoCapture("../Videos/testScenario2.mp4")  # for road video
# cap_road2 = cv2.VideoCapture("../Videos/testScenario2.mp4")  # for road2 video
...
while True:
    ...
    if traffic_light_state == 2 and 50 <= elapsed_time <= 150:
