...
cap_road = cv2.VideoCapture("../Videos/newVideo.mp4")  # No bare road and available instance within first 30s
cap_road2 = cv2.VideoCapture("../Videos/newVideo.mp4")  # No bare road and available instance within first 30s
