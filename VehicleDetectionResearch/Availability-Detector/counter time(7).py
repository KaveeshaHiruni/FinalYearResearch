...
# counter starts
limits = [100, 350, 673, 350]
totalCount = []

# Step 1: Initialize availability variable
availability = True

# Step 2: Initialize the start time
...
while True:
    ...
    for result in resultsTracker:
        ...
        # Step 4: Reset counter after every 20 seconds
        if elapsed_time >= 20:
            totalCount = []  # Reset the totalCount list
    ...
    cv2.putText(img, timer_text, (50, img.shape[0] - 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2,
                cv2.LINE_AA)
    cv2.putText(img, timer_text, (50, img.shape[0] - 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2,
                cv2.LINE_AA)
