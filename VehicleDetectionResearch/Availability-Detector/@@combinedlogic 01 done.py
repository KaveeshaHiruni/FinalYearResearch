...
# limits = [335, 150, 673, 150]
limits = [160, 80, 340, 80]
limits1 = [10, 300, 360, 300]
...
while True:
    ...
    if availability_road:
        ...
        cv2.putText(img_road, "Unavailable", (img_road.shape[1] - 270, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2,
                    cv2.LINE_AA)
    ...
    availability_position = (300, img_road.shape[0] - 340)
