...
# limits = [335, 150, 673, 150]
limits = [100, 100, 350, 100]
limits1 = [20, 200, 500, 200]
...
while True:
    ...
    cv2.putText(img_road, timer_text, (50, img_road.shape[0] - 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2,
                cv2.LINE_AA)
    cv2.putText(img_road2, timer_text, (50, img_road2.shape[0] - 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2,
                cv2.LINE_AA)
